...
Lastly, the group_name variable could be relatively interesting as well for some quality control.
...
Rename the data as clean then take a final glimpse.

```{r}
WQ_clean_data <- group_recode
