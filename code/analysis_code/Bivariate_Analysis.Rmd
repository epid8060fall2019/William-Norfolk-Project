...
Lastly in our bivariate analysis we will zoom into three specific locations that represent the most numerous observations of Seagrass/Mangrove, Patch Reef/Hardbottom, and Coral Reef site types to visualize specific seasonal impacts on these locations. 
...
grid.arrange(mean_temp_plot_roddy, mean_temp_plot_tarpon, mean_temp_plot_grecian, nrow = 2)
