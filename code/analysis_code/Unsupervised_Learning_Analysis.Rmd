...
good_tree_hclust <- plot(cluster_site_hclust, cex = 0.6, hang = -1, main = "Agglomerative (hclust) Dendrogram of All Sample Locations")
good_tree_agnes <- pltree(cluster_site_agnes, cex = 0.6, hang = -1, main = "Agglomerative (agnes) Dendrogram of All Sample Locations")
good_tree_diana <- pltree(cluster_site_diana, cex = 0.6, hang = -1, main = "Divisive Dendrogram of All Sample Locations")
...
sample_site_dendro_agnes <- fviz_dend(cluster_site_agnes, k = 5, show_labels = TRUE, cex = 0.55, rect = FALSE, color_labels_by_k = FALSE, horiz = TRUE, rect_lty = 5, rect_border = 8, main = "Agglomerated Dendrogram (agnes) of All Sample Sites")

sample_site_dendro_agnes

sample_site_dendro_hclust <- fviz_dend(cluster_site_hclust, k = 5, show_labels = TRUE, cex = 0.6, rect = FALSE, color_labels_by_k = FALSE, horiz = TRUE, rect_lty = 5, rect_border = 8, main = "Agglomerated Dendrogram (hclust) by Sample Site")
...
```{r save the total dendrogram}
#Save the dendro as a png and set the demensions
png("sample_site_dendro_agnes.png", width = 650,height = 400)
print(sample_site_dendro_agnes)
dev.off()

#Use filesstrings to move the file to the repo folder
file.move("./sample_site_dendro_agnes.png", "../../results/Unsupervised_Modeling_Figures", overwrite = TRUE)#Be sure to include overwrite = TRUE or you will add a file everytime you rerun
```
...
hclust_vs_agnes_tangle <- tanglegram(cluster_site_hclust, cluster_site_agnes, highlight_distinct_edges = FALSE, common_subtrees_color_branches = FALSE, lwd = 2, k_branches = 5, lab.cex = 0.7, main = paste("All Sites (hclust vs agnes) Entanglement =", round(entanglement(all_site_dend), 2)))
...
```{r}
png("sg_mg_good_dend.png", width = 650,height = 400)
print(sg_mg_good_dend)
dev.off()

file.move("./sg_mg_good_dend.png", "../../results/Unsupervised_Modeling_Figures", overwrite = TRUE)
```
...
```{r}
png("pr_h_good_dend.png", width = 650,height = 400)
print(pr_h_good_dend)
dev.off()

file.move("./pr_h_good_dend.png", "../../results/Unsupervised_Modeling_Figures", overwrite = TRUE)
```
...
cr_dend <- pltree(cr_clust, cex = 0.5, hang = -1, main = "Coral Reef Cluster Test", labels = cr_ready$location)

cr_good_dend <- fviz_dend(cr_clust, k = 2, show_labels = TRUE, cex = 0.55, rect = FALSE, color_labels_by_k = FALSE, horiz = TRUE, rect_lty = 5, rect_border = 8, main = "Coral Reef Cluster Analysis")

cr_good_dend
```

```{r}
png("cr_good_dend.png", width = 650,height = 400)
print(cr_good_dend)
dev.off()

file.move("./cr_good_dend.png", "../../results/Unsupervised_Modeling_Figures", overwrite = TRUE)
```
...
```{r}
png("good_adend_16.png", width = 650,height = 400)
print(good_adend_16)
dev.off()

file.move("./good_adend_16.png", "../../results/Unsupervised_Modeling_Figures", overwrite = TRUE)
```
...
```{r}
png("good_adend_17.png", width = 650,height = 400)
print(good_adend_17)
dev.off()

file.move("./good_adend_17.png", "../../results/Unsupervised_Modeling_Figures", overwrite = TRUE)
```
...
```{r}
png("good_adend_18.png", width = 650,height = 400)
print(good_adend_18)
dev.off()

file.move("./good_adend_18.png", "../../results/Unsupervised_Modeling_Figures", overwrite = TRUE)
```
...
```{r}
png("good_adend_19.png", width = 650,height = 400)
print(good_adend_19)
dev.off()

file.move("./good_adend_19.png", "../../results/Unsupervised_Modeling_Figures", overwrite = TRUE)
```
...
good_adend_tarpon <- fviz_dend(clust_tarpon_agnes, k = 2, show_labels = TRUE, cex = 0.8, rect = FALSE, color_labels_by_k = FALSE, horiz = TRUE, rect_lty = 5, rect_border = 8, main = "Tarpon Basin Seasonal Cluster Analysis (agnes)")
...
```
```{r}
png("good_adend_tarpon.png", width = 650,height = 400)
print(good_adend_tarpon)
dev.off()

file.move("./good_adend_tarpon.png", "../../results/Unsupervised_Modeling_Figures", overwrite = TRUE)
```
...
good_adend_roddy <- fviz_dend(clust_roddy_agnes, k = 4, show_labels = TRUE, cex = 0.8, rect = FALSE, color_labels_by_k = FALSE, horiz = TRUE, rect_lty = 5, rect_border = 8, main = "Rodriguez Key Seasonal Cluster Analysis (agnes)")
...
```{r}
png("good_adend_roddy.png", width = 650,height = 400)
print(good_adend_roddy)
dev.off()

file.move("./good_adend_roddy.png", "../../results/Unsupervised_Modeling_Figures", overwrite = TRUE)
```
...
good_adend_grecian <- fviz_dend(clust_grecian_agnes, k = 3, show_labels = TRUE, cex = 0.8, rect = FALSE, color_labels_by_k = FALSE, horiz = TRUE, rect_lty = 5, rect_border = 8, main = "Grecian Dry Rocks Seasonal Cluster Analysis (agnes)")
...
```
```{r}
png("good_adend_grecian.png", width = 650,height = 400)
print(good_adend_grecian)
dev.off()

file.move("./good_adend_grecian.png", "../../results/Unsupervised_Modeling_Figures", overwrite = TRUE)
```
