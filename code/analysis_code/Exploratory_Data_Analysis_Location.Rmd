...
site_type_ph <- ggplot(island_side_filter, aes(x = site_type, y = ph, color = site_type)) + geom_violin(width = 1) + geom_jitter(alpha = 0.25) + ggtitle("pH by Site Type") + xlab("") + ylab("pH") + theme(legend.position = "none", axis.text.x = element_text(face = "bold"))
