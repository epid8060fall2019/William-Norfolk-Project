...
```{r}
prp(fit1$finalModel, extra = 1, type = 5)
```
...
```{r}
prp(fit2$finalModel, extra = 1, type = 5)
...
Based on the random forest it looks like or data has the greatest accuracy when scaled with 6-7 predictors. 

##### Tree without salinity compare predictors
