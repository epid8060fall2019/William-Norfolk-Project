...
The full fit drops the second temperature branch, this si likely due to a low number of observations below 20 degrees, which is extremely cold for Key Largo however not unreasonable. 
...
```
```{r}
cs_best_tree <- prp(fit333$finalModel, extra = 8, type = 2, main = "Key Water Quality Predictors of Citizen Science Data")
cs_best_tree
