...
subset(mean_water_temp, Year == "16") %>% ggplot() + 
  geom_smooth(aes(x = Month, y = water_temp))
```
...
Make a plot for all months of all years. Ideally with all parameters on seperate lines to view seasons.

Add comentary to this Rmd. 
