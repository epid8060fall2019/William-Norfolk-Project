...
```{r}
compare_water_temp <- ggplot(cs_fknms_combined, aes(x = location, y = water_temp, fill = Source)) + geom_boxplot() + theme(axis.text.x = element_text(angle = 45, hjust = 1))
...
```{r}
compare_sal <- ggplot(cs_fknms_combined, aes(x = location, y = salinity, fill = Source)) + geom_boxplot() + theme(axis.text.x = element_text(angle = 45, hjust = 1))
...
```{r}
compare_do <- ggplot(cs_fknms_combined, aes(x = location, y = dissolved_oxygen, fill = Source)) + geom_boxplot() + theme(axis.text.x = element_text(angle = 45, hjust = 1))
...
```{r}
compare_amm <- ggplot(cs_fknms_combined, aes(x = location, y = ammonia, fill = Source)) + geom_boxplot() + theme(axis.text.x = element_text(angle = 45, hjust = 1))
