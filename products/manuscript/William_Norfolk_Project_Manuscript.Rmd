...
The analysis of the MarineLab citizen science water quality data shows the utility of ctizen science monitoring as a tool for the mass collection of data. The greatest strenght of this analysis was the successful characterization of broad-scale water quality patterns of Key Largo, Florida. Citizen sciences data was able to capture the general patterns of water conditions based on location, season, and hurricane effects. These data show the value of citizen science monitoring as an effective tool to gather information on the local environment. This strength is supported by the citizen science efficacy analysis which showed as highly similar trends in water quality conditions when citizen science data was compared to sanctuary data. Despite this strength, this analysis shows that citizen science data accuracy is limited to the borad-scale trends in water quality and is thus not reccomended fo research requiring highly accurate measures. 
Additional limitations to this study are likely due to the 
